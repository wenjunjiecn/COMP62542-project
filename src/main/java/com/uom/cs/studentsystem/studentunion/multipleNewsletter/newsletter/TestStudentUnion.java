...
public class TestStudentUnion {
    public static void main(String[] args) {
        ...
        //register observers to specific newsletter
        topic.registerSpecificNewsletter(obj1, "AcademicNewsletter");
        topic.registerSpecificNewsletter(obj2, "SportsNewsletter");
        topic.registerSpecificNewsletter(obj3, "AcademicNewsletter");
        topic.registerSpecificNewsletter(obj3, "SportsNewsletter");

        topic.postAllMessage();
